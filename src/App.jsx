  ...
  return (
    <div className=" h-screen w-screen flex items-center justify-center relative">
      ...
      >
        ...
        <h1 className=" font-[700] px-3 font-Inter w-full text-[17px]">
          Welcome To <span className=" text-[#594EF1]">FTR Client</span>
        </h1>
        <h3 className=" text-[#9E9E9E] px-3 w-full font-[700] font-Inter text-[10px]">
          Let Store Owners Scan Your Barcode
        </h3>
        <div className="flex h-[45px] px-3 items-center w-full">
        ...
        <div className="flex  items-center px-3 justify-between w-full">
          <h1 className="text-[13px] font-[600] font-Inter">My Receipts</h1>
          <h1 className="flex items-center justify-center font-[600] text-[9px] font-Inter">
            See all{" "}
